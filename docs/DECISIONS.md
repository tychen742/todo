...
- Top-level workspace tab buttons: `height: 30`, `paddingVertical: 2`, `paddingHorizontal: 6`; tabs render as a connected strip with a rounded active tab and short vertical dividers only between inactive tabs.
