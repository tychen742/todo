...
- Top-level workspace tab buttons: `height: 30`, `paddingVertical: 2`, `paddingHorizontal: 2`; tabs use browser-style rounded top corners and active-tab round-out bottom shoulders.
