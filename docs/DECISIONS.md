...
- The add todo band and todo board share a centered `1200px` max width on web-sized layouts so the task text column does not create a large empty center gap on ultrawide screens.
