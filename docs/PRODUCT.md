...
- Header search should filter the active workspace list, completed todos, Inbox To you and From you sections, and visible project cards by task text, notes, project context, assignees, creators, priority, due date, and workflow status.
