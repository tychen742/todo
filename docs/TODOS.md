...
- Notes tab: top-level workspace tab with local Ideas plus a New Mindmap template picker and saved mindmaps with direct node editing, a canvas control for top-level nodes, and child-node add controls on edge nodes.
